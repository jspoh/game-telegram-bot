        ...
        case 'get':
            match user_msg:
                ...
                case 'iss coordinates':
                    ...
                    context.bot.send_message(chat_id=update.effective_chat.id, text=f"Longitude: {iss_coord['iss_position']['longitude']}\nLatitude: {iss_coord['iss_position']['latitude']}")
                case 'joke':
                ...
                case 'would you rather':
                    match user_msg:
                        case 'start' | 'next':
                            ...
                            context.bot.send_message(chat_id=update.effective_chat.id, text=msg, reply_markup=ReplyKeyboardMarkup([[KeyboardButton('Next')], [KeyboardButton('Back')]]))
                        case 'back':
                            context.bot.send_message(chat_id=update.effective_chat.id, text='Returning..', reply_markup=ReplyKeyboardRemove(True))
                            game_command(update, context)
                ...
                case _:
                    match user_msg:
                        case 'truth or dare':
                            ...
                            context.bot.send_message(chat_id=update.effective_chat.id, text=f'{update.message.text} selected!', reply_markup=ReplyKeyboardMarkup([[KeyboardButton('Truth')], [KeyboardButton('Dare')], [KeyboardButton('Back')]]))
                        case 'would you rather':
                            game_type = 'would you rather'
                            context.bot.send_message(chat_id=update.effective_chat.id, text=f'{update.message.text} selected!', reply_markup=ReplyKeyboardMarkup([[KeyboardButton('Start')], [KeyboardButton('Back')]]))
                        case 'never have i ever':
                        ...
                        case "king's cup":
                            game_type = 'kings cup'
                            context.bot.send_message(chat_id=update.effective_chat.id, text="I'm still working on this one :)")
                        case 'back':
                            context.bot.send_message(chat_id=update.effective_chat.id, text='Returning..', reply_markup=ReplyKeyboardRemove(True))
                            start_command(update, context)
                        case _:
